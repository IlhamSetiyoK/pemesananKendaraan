...
<div class="container mt-2">
    ...
    <form action="{{ route('transaction.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <input type="hidden" name="nama_admin_peminjaman" value="{{ Auth::user()->name }}">
            <input type="hidden" name="status_peminjaman" value=0>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Mulai Peminjaman:</strong>
                    <input type="date" name="mulai_peminjaman" class="form-control" placeholder="YYYY-MM-DD">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="date" name="selesai_peminjaman" class="form-control" placeholder="YYYY-MM-DD">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="alasan_peminjaman" class="form-control" placeholder="Masukkan Alasan Peminjaman">
