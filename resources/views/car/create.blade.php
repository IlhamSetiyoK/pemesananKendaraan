        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="identitas_kendaraan" class="form-control" placeholder="A0XXX / B0XXX">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="date" name="jadwal_service_kendaraan" class="form-control" placeholder="YYYY-MM-DD">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="sisa_bbm_kendaraan" class="form-control" placeholder="60 (Liter)">
